...
export default function PlainNode({ id, data, selected }: any) {
  ...
  return (
    <div className="relative w-full h-full group">
      ...
      <div className={`w-full h-full px-4 py-2 border-2 border-gray-800 bg-white text-center shadow-sm flex items-center justify-center ${selected ? 'ring-2 ring-blue-500' : ''}`}>
